...
import { OpenVidu, Session } from '../../public/openvidu-browser-2.15.0.js';
           ...
           {  <div id="main-container" className="container">
                ...
                <div id="not-logged" className="vertical-center">
                    <form className="form-group jumbotron" onSubmit={() => {
                        ...
                        <p>
                            <label>User</label><input className="form-control" type="text" id="user" required></input>
                        </p>
                        <p>
                            <label>Pass</label><input className="form-control" type="password" id="pass" required></input>
                        </p>
                        <p className="text-center">
                            <button className="btn btn-lg btn-info" onClick={logIn}>Log in</button>
                        </p>
                    </form>
                    <table className="table">
                        <tr>
                            ...
                            <th>Role<i data-toggle="tooltip" data-placement="bottom" title="" data-original-title="<div id='tooltip-div'>PUBLISHER<div>Send and receive media<hr></div>SUBSCRIBER<div>Receive media</div></div>"
                                className="glyphicon glyphicon-info-sign"></i></th>
                        </tr>
                        <tr>
                            <td>publisher1</td>
                            <td>pass</td>
                ...
                <div id="logged" hidden>
                        ...
                        <div id="join-dialog" className="jumbotron">
                            ...
                            <form className="form-group" onSubmit={() => {
                                ...
                                <p>
                                    ...
                                    <input className="form-control" type="text" id="nickName" required></input>
                                </p>
                                <p>
                                    <label>Session</label>
                                    <input className="form-control" type="text" id="sessionName" required></input>
                                </p>
                                <p className="text-center">
                    ...
                    <div id="session" style={{ display: "none" }}>
                        <div id="session-header">
                            ...
                            <input className="btn btn-large btn-danger" type="button" id="buttonLeaveSession" onMouseUp={removeUser(), leaveSession()} value="Leave session"></input>
                        </div>
